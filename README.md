# PSOC&trade; Control C1 MCU: VADC EMUX

This code example demonstrates the VADC capability to drive a external multiplexer automatically by  output pins in PSOC&trade; Control C1 MCU. The successful completion of EMUX control in sequence mode is indicated by observing the waveform from EMUX output pins which changes automatically in the sequence 7,6,5,4,3,2,1,0,7,6...

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242915-vadc-emux)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[VADC emux](https://github.com/Infineon/mtb-example-ce242915-vadc-emux)" application with the desired name "VADC emux" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242915-vadc-emux --user-app-name VADC emux --target-dir "C:/mtb_projects"
   ```
...
4. Connect VADC EMUX pins to selection lines of external multiplexer or observe the behaviour using logic analyser (EMUXx0 = P0.4, EMUXx1 = P0.3, EMUXx2 = P0.2)  
...
| VADC (PDL)  | VADC_G0        | VADC Group 0 used for analog-to-digital conversion via the EMUX-controlled input channel |
...
Document title: *CE242915* – *PSOC&trade; Control C1 MCU: VADC emux*
